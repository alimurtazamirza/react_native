...
const Search = ({ navigation }) => {
  const initialMapState = {
    ...
    categories: [
      ...
      {
        name: "Users",
        icon: <FontAwesome5 name="users" style={styles.chipsIcon} size={18} />,
      },
      {
        name: "Male",
        icon: <FontAwesome name="male" style={styles.chipsIcon} size={18} />,
      },
      {
        name: "Female",
        icon: <FontAwesome name="female" style={styles.chipsIcon} size={18} />,
      },
    ],
    region: {
      latitude: 22.62938671242907,
      longitude: 88.4354486029795,
      latitudeDelta: 10.09864195044303443,
      longitudeDelta: 10.0142817690068,
    },
  };
    ...
    <KeyboardDismiss>
      <View style={styles.container}>
        ...
        <View style={styles.searchBox}>
          ...
          />
          <Ionicons name="ios-search" size={23} style={{ paddingTop: 3 }} />
        </View>
        <ScrollView
          horizontal
